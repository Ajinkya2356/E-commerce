...
<head>
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              ...
              <input name="add13" type="text" class="form-control" id="address" placeholder="1234 Main St" required>
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input name="add13" type="text" class="form-control" id="address2" placeholder="Apartment or suite">
            </div>

            <div class="row">
              <div class="col-md-5 mb-3">
                <label for="country">Country</label>
                <select name="state" class="custom-select d-block w-100" id="country" required>
  ...
  <footer class="my-5 pt-5 text-muted text-center text-small">
    <p class="mb-1">© 2021 - 2045 Infinity.com</p>
